    ...
    private fun getSystemSchema(schemaId: String): Schema? {
        return when {
            ...
            schemaId.startsWith("communication_module_") -> {
                // Communication module schemas (IDs generated by CommunicationModuleSchemas)
                LogManager.service("Communication module schema requested: $schemaId")
                // Map schemaId to module type (e.g., "communication_module_multiplechoice" -> "MultipleChoice")
                val moduleType = when (schemaId) {
                    "communication_module_multiplechoice" -> "MultipleChoice"
