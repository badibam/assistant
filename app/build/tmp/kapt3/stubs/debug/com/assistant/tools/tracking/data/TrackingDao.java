...
public abstract interface TrackingDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM tracking_data WHERE tool_instance_id = :instanceId ORDER BY recorded_at DESC")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getEntriesForToolInstance(@org.jetbrains.annotations.NotNull()
    java.lang.String instanceId, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super java.util.List<com.assistant.tools.tracking.entities.TrackingData>> $completion);
}